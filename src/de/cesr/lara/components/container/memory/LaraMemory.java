 ...
 */
public interface LaraMemory<PropertyType extends LaraProperty<?>> extends
	 ...
	 *            the property to be memorised. Created by Michael Elbers on
	 *            21.02.2010
	 ...
	 * of the specified type and identified with {@code key}.
	 * 
	 * @param propertyType
	 * @param key
	 ...
	 * specified type, was memorised in {@code step} and identified with
	 * {@code key}.
	 * 
	 * @param propertyType
	 * @param key
