 ...
 * @date 12.02.2010
 */
public abstract class LaraBehaviouralOption<A extends LaraAgent<A, ? super BO>, BO extends LaraBehaviouralOption<A, BO>>
		extends LaraProperty<Map<Class<? extends LaraPreference>, Double>>
	...
	public boolean equals(Object o) {
		...
		if (o instanceof LaraBehaviouralOption<?, ?>) {
			...
			// TODO check advantages/disadvantages of comparing actual values
			// for getValue()
	...
	public float getTotalSituationalUtility(LaraDecisionConfiguration dBuilder) {
		...
		for (Entry<Class<? extends LaraPreference>, Double> utilityEntry : goals
			...
			situationalGoalPreference = agent.getLaraComp()
					...
					.getSituationalPreferenceWeights()
	...
	public String toString() {
		...
		for (Map.Entry<Class<? extends LaraPreference>, Double> entry : sortedSet) {
			buffer.append(entry.getKey().getSimpleName() + ": "
					+ format.format(entry.getValue().doubleValue()) + "; ");
		}
