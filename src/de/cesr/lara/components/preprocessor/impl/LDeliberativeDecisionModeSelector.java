 ...
 * @date 10.07.2009
 */
public class LDeliberativeDecisionModeSelector<A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<? super A, BO>>
		implements LaraDecisionModeSelector<A> {

	/**
	 * Always selects the matrix deliberation mode (
	 * {@link LDeliberativeDeciderFactory}. This default implementation is used
	 * in {@link LPreprocessFactory}.
	 * 
	...
	public void selectDecisionMode(A agent,
		...
		agent.getLaraComp()
				...
				.setDeciderFactory(
						LDeliberativeDeciderFactory.getFactory((Class<A>) agent
								.getClass()));
	}
}