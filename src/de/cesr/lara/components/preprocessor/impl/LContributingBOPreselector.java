...
/**
 * 
 * Retrieves all recent behavioural options in memory and checks for each if any utility > 0.0 contributes to the
 * decision represented by this decision builder.
 * 
 * @param <A>
 ...
 * @date 13.11.2009
 */
public class LContributingBOPreselector<A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<?, BO>>
		implements LaraBOCollector<A, BO> {

	/**
	 * Retrieves all recent behavioural options in memory and checks for each if any utility > 0.0 contributes to the
	 * decision represented by this decision builder. Contributing behavioural options are returned.
	 * 
	 * @see de.cesr.lara.components.preprocessor.LaraBOCollector#collectBOs(de.cesr.lara.components.agents.LaraAgent,
	 *      de.cesr.lara.components.container.memory.LaraBOMemory, de.cesr.lara.components.decision.LaraDecisionConfiguration)
	 */
	@Override
