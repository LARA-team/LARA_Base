...
/**
 * This configurator is used to configure a {@link LaraPreprocessorFactory} with
 ...
 * fulfil ? super (? super BO) regarding BO parameter for the component (in
 ...
 * 
 */
public interface LaraPreprocessorConfiguration<A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<? super A, BO>> {
	 ...
	 * {@link LaraPreprocessorConfiguration#setBOAdapter(LaraBOUtilityUpdaterBuilder)}
	 * and sets the default.
	 * 
	 * @param boUpdater
	 * @param dConfiguration
	 *            The {@link LaraDecisionConfiguration} the given behavioural
	 *            options utilityUpdater shall be applied to. Created by Sascha
	 *            Holzhauer on 10.02.2010
	 */
	public void setBOAdapter(LaraBOUtilityUpdaterBuilder<A, BO> boUpdater,
	...
	/**
	 * Specifying <code>null</code> corresponds to
	 * {@link LaraPreprocessorConfiguration#setBOCollector(LaraBOCollector)} and
	 * sets the default.
	 * 
	 * @param bOCollector
	 * @param dConfiguration
	 *            The {@link LaraDecisionConfiguration} the given behavioural
	 *            options collector shall be applied to. Created by Sascha
	 *            Holzhauer on 10.02.2010
	 */
	public void setBOCollector(LaraBOCollector<A, BO> bOCollector,
			LaraDecisionConfiguration dConfiguration);
	...
	/**
	 * Specifying <code>null</code> corresponds to
	 * {@link LaraPreprocessorConfiguration#setBOChecker(LaraBOPreselector) )}
	 * and sets the default.
	 * 
	 * @param boPreselector
	 * @param dConfiguration
	 *            The {@link LaraDecisionConfiguration} the given behavioural
	 *            options preselector shall be applied to. Created by Sascha
	 *            Holzhauer on 10.02.2010
	 */
	...
	public void setDecisionModeSelector(
			LaraDecisionModeSelector<A> decisionModeSelector);

	/**
	 * Specifying <code>null</code> corresponds to
	 * {@link LaraPreprocessorConfiguration#setDecisionModeSelector(LaraDecisionModeSelector)
	 * )} and sets the default.
	 * 
	 * @param decisionModeSelector
	 * @param dConfiguration
	 *            The {@link LaraDecisionConfiguration} the given mode selector
	 *            shall be applied to. Created by Sascha Holzhauer on 10.02.2010
	 */
	public void setDecisionModeSelector(
			LaraDecisionModeSelector<A> decisionModeSelector,
			LaraDecisionConfiguration dConfiguration);
	...
	public void setPreferenceUpdater(
			LaraPreferenceUpdater<? extends A> prefUpdater);

	/**
	 * Specifying <code>null</code> corresponds to
	 * {@link LaraPreprocessorConfiguration#setPreferenceUpdater(LaraPreferenceUpdater)}
	 * and sets the default.
	 * 
	 * @param prefUpdater
	 * @param dConfiguration
	 *            The {@link LaraDecisionConfiguration} the given preference
	 *            utilityUpdater shall be applied to. Created by Sascha
	 *            Holzhauer on 10.02.2010
	 */
	public void setPreferenceUpdater(
			LaraPreferenceUpdater<? extends A> prefUpdater,
