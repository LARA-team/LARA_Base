...
/**
 * Collects behavioural options from the BO-memory. The collection may be filtered by certain criteria. Note that
 * normally afterwards the {@link LaraBOPreselector} is applied to each BO.
 * 
 * @param <A>
...
public interface LaraBOCollector<A extends LaraAgent<? super A, ?>, BO extends LaraBehaviouralOption<?, ?>>
	 ...
	 */
	public abstract Collection<BO> collectBOs(A agent, LaraBOMemory<BO> memory, LaraDecisionConfiguration dConfiguration);
}
