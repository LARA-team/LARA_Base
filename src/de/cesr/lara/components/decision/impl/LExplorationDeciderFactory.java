 ...
 */
public class LExplorationDeciderFactory<A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<A, BO>>
	...
	public static <A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<A, BO>> LaraDeciderFactory<A, BO> getFactory(
			Class<A> clazz) {
