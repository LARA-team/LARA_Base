 ...
 */
public class LNoOptionDeciderFactory<A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<?, ? extends BO>>
	...
	public static <A extends LaraAgent<A, BO>, BO extends LaraBehaviouralOption<?, ? extends BO>> LaraDeciderFactory<A, BO> getFactory(
		...
		if (LExplorationDeciderFactory.clazz != clazz || factory == null) {
			...
			factory = new LNoOptionDeciderFactory<A, BO>();
		}
		return (LaraDeciderFactory<A, BO>) factory;
	}

	private LNoOptionDeciderFactory() {
	}
	...
	public LaraDecider<BO> getDecider(A agent, LaraDecisionConfiguration dConfiguration) {
		return new LNoOptionDecider<BO>(LaraDecisionModes.HEURISTICS);
	}
}
